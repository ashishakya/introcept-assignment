...
# SCM #
#####################################################################################
set :repo_url,        :'git@github.com:ashishakya/introcept-assignment.git'
set :repo_base_url,   :'https://github.com'

# set :repo_diff_path,  :'web-apps/introcept-support-to-lg-tdh/compare/master...'
# set :repo_branch_path,:'web-apps/introcept-support-to-lg-tdh/commits'
# set :repo_commit_path,:'web-apps/introcept-support-to-lg-tdh/commit'
...
namespace :introcept do
    ...
    desc "Move files from storage/exports to shared/exports"
        task :move_emis_templates do
            on roles(:all) do
                execute "cp -Rpf #{release_path}/storage/exports #{shared_path}/storage/"
            end
        end
...
namespace :devops do
    ...
    task :set_up do
        on roles(:all) do
            invoke "introcept:create_storage_folder"
            invoke "introcept:create_overlay_folder"
            invoke "introcept:create_uploads_folder"
            invoke "introcept:create_imports_folder"
        end
    end
...
#     after :published, "introcept:move_imports" #Make sure to call this before creating symlink
#     after :published, "introcept:move_emis_templates" #Make sure to call this before creating symlink
    after :published, "introcept:create_symlink"
    after :finished, "introcept:create_ver_txt"
